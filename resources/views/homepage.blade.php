...
>
    <div class="logos__container container grid">
        ...
        <div class="logos__img">
            <img src="{{ asset('frontend/assets/img/traveloka.webp') }}" alt="" />
        </div>
        <div class="logos__img">
            <img src="{{ asset('frontend/assets/img/wonderfull.png') }}" alt="" />
        </div>
        <div class="logos__img">
            <img src="{{ asset('frontend/assets/img/tiketcom.webp') }}" alt="" />
        </div>
    </div>
</section>
    ...
    <div class="value__container container grid">
        <div class="value__images">
            ...
            <div class="value__img">
                <img src="{{ asset('frontend/assets/img/servis.png') }}" alt="" />
            </div>
        </div>
